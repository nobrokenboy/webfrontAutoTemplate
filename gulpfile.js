...
gulp.task("htmlmin",function(){
    ...
    gulp.src(["./develop/views/**/*.html","./develop/views/**/*.sb"])
...
gulp.task("watch",function(){
    gulp.run(["css","jshint","webpack","imagemin","font","htmlmin"]);
    gulp.watch("./develop/static/css/**/*.scss",["css"]);
    gulp.watch("./develop/static/js/**/*.js",["jshint","webpack"]);
    gulp.watch("./develop/static/img/**/*.{jpg,gif,svg,png,ico}",["imagemin"]);
    gulp.watch("./develop/static/font/**/*.*",["font"]);
    gulp.watch(["./develop/views/**/*.html","./develop/views/**/*.sb"],["htmlmin"]);
